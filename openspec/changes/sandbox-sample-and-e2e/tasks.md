...
- [ ] 1.3 Split reference-app output into an exact MPS-only signature JAR containing the complete compiled class set and an app-only support JAR used by `compileGeneratedJava`.
