...
## Purpose
The core MPS structure concepts of the `causeway` DSL — `Module`, `Entity`, `Property`, `Action`, `Parameter`, and the `Type` union (`EntityType` ∪ `JavaType`) — and how they compose.
