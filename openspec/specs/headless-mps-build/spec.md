# headless-mps-build Specification

## Purpose

Define the reproducible command-line pipeline that bootstraps the Causeway MPS language, generates models, gates them with modelcheck, and compiles generated Causeway Java.
