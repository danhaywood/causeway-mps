# dsl-action-mixin-runtime Specification

## Purpose

Verify that Java classes generated from nested and explicit-target DSL actions satisfy the Apache Causeway 3.6 runtime mixin contract.
