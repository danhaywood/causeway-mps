# dsl-derived-properties Specification

## Purpose

Define calculated scalar property declarations, their placement and typing rules, and their separation from persisted entity state.
